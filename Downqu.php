...
<div class="form1">
<h1>DownLoad Queston Paper</h1>
<div id="error" style="margin-bottom:10px; color:#F00; text-align:center;"></div>
<form action="Result1.php" method="post" target="_blank" >
...
<input type="submit" value="DOWNLOAD QUESTION PAPER" onclick="return Validate();" name="submit" />
</form>
</div>
</br></br>
</section>
