...
<title>Faculty LogIn Session</title>
...
$sql="SELECT * FROM reg_faculty WHERE faculty_name='$facname' and faculty_pass='$facpass'";
...
<div class="form1">
<h1>LogIn Portal For Faculty Member</h1>
<center><div id="error" style="color:red; margin-bottom:10px;"> </div></center>
<div class="Errormsg"><?php echo $Errormsg ?></div>
<form action="FacultyLogin.php" method="post" enctype="application/x-www-form-urlencoded">
